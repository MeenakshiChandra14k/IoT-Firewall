...
A high-concurrency C++ security service that helps resource-constrained IoT devices block malicious traffic using memory-efficient Counting Bloom Filters.

### System Preview

![System Preview](assets/preview.png)
![Log Preview](assets/logImage.png)
